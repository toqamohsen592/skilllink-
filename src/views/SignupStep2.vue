    ...
    <div class="step-container">
      ...
      <div class="form-card">
        ...
        <div class="form-row">
          ...
          <div v-if="form.skills.length" class="skills-preview">
            <span v-for="(skill, index) in form.skills" :key="index" class="skill-chip">{{ skill }}</span>
          </div>
        </div>

        <div class="form-row">
          <label>Education</label>
          <input v-model="form.university" placeholder="University / Institute" style="margin-bottom:15px">
          <input v-model="form.college" placeholder="College" style="margin-bottom:15px">
          <input v-model="form.studyYears" placeholder="Years of study ex2021-2024">
        </div>
        ...
        <div class="form-row">
          ...
          <div class="input-with-icon">
            ...
            <input v-model="form.linkedin" placeholder="Linkedin Profile URL">
          </div>
          
          <div class="input-with-icon">
            <i class="fab fa-github"></i>
            <input v-model="form.github" placeholder="GitHub Profile URL">
          </div>
          
          <div class="input-with-icon">
            <i class="fab fa-behance"></i>
            <input v-model="form.behance" placeholder="Behance Profile URL">
          </div>
        </div>
...
import { normalizeSkillsList } from '../utils/profileMapper'
...
export default {
  data() {
    ...
    return {
      ...
      form: {
        ...
        college: draft.college || draft.major || '',
  ...
  methods: {
    addSkill() {
      const added = normalizeSkillsList(this.skillInput)
      added.forEach((skill) => {
    ...
    continueStep() {
      if (this.skillInput.trim()) this.addSkill()
      saveSignupDraft({ ...this.form, major: this.form.college })
...
.skills-preview { display: flex; flex-wrap: wrap; gap: 8px; margin-top: 12px; }
.skill-chip { background: #E8F5F5; border: 1px solid #0C9892; color: #0C9892; border-radius: 20px; padding: 6px 12px; font-size: 14px; }
