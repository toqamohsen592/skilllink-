<template>
  <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm">
    <div class="container-fluid px-4">
      <a class="navbar-brand d-flex align-items-center" href="#" @click.prevent="$router.push('/client-home')">
      ...
      <div class="nav-icons-wrapper d-flex align-items-center gap-3">
        ...
        <img src="/src/assets/comunity.png" alt="Community" class="nav-icon" @click="$router.push('/client-community')">
        ...
        <div class="profile-pic" @click="$router.push('/client-profile')">
          <img src="/src/assets/pexels danx.jpg" alt="Profile" class="rounded-circle">
        </div>
...
export default {
  ...
  data() {
    return {
      ...
      messageCount: 3, notificationCount: 2,
      messagesList: [
  ...
  methods: {
    ...
    logout() { alert('Logout coming soon!'); this.showMenu = false; },
